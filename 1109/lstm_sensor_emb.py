...
if __name__ == '__main__':
    ...
    for ind, important_ind in enumerate(important_inds):
        ...
        X_train, X_test, y_train, y_test = TTS(X, y, test_size=0.2, random_state=668)
    ...
    save_dir = r'D:\work\project\卡尔蔡司AR镀膜\ML_ZEISS-dev\data\1106_tf_li_gong_review'
