...
def overfiting(X, Y):
    ...
    param1 = json.load(open(r'./parameter_{}_tf.json', 'r'))
    num_round = 200
...
if __name__ == '__main__':
    ...
    # embedding thickness search
    save_dir = r'D:\work\project\卡尔蔡司AR镀膜\ML_ZEISS-dev\data\1103_tf_li_gong_review'
